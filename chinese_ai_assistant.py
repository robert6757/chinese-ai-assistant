...
class ChineseAIAssistant:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ChineseAIAssistant', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/chinese_ai_assistant/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Chinese AI Assistant'),
            callback=self.run,
    ...
    def onClosePlugin(self):
        ...
        #print "** CLOSING ChineseAIAssistant"
    ...
    def unload(self):
        ...
        #print "** UNLOAD ChineseAIAssistant"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Chinese AI Assistant'),
                action)
